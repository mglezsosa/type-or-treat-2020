...
type T = { areGods: { god: true }, areDemons: { demon: true; sendBackToHell(): void }, areEctoPlasmic: { ectoplasmic: true } }
declare const { areGods, areDemons, areEctoPlasmic }: { [K in keyof T]: (ghosts: Ghosts[]) => ghosts is (Ghosts & T[K])[] }
